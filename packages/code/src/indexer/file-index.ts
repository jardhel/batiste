/**
 * File index tracking with JSON persistence.
 *
 * Maintains a mapping of file paths to their indexed state (hash, mtime,
 * chunk count) and persists to disk as JSON. Used to detect which files
 * have changed between indexing runs.
 */
