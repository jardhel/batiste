export { GitAwareIndexer, type IndexState, type IncrementalIndexPlan } from './git-aware-indexer.js';
export { GitTracker, type GitFileInfo, type GitDiffResult, type GitStatus } from './git-tracker.js';
