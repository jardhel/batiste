/**
 * TaskManager - Manages a DAG of tasks with persistence
 *
...
import type { Task, TaskStatus, TaskNode, ITaskStore, ToolOutputCache } from './types.js';
...
export class TaskManager {
  ...
  /**
   * Check if a tool output is cached
   */
  ...
  /**
   * Recover all tasks from the store (used after process restart)
   */
